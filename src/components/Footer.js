        ...
        <div className="footer">
            <div className="footer-container">
                ...
                <div className="right">
                    ...
                    <p>I'm Mohammad Asif Parimoo, a skilled Front End and React Native developer. I create visually stunning and highly functional websites and mobile applications using cutting-edge technologies. With my expertise in these areas, I aim to bring your ideas to life and provide innovative solutions that meet the highest standards of quality and reliability.</p>
